#!/usr/bin/env python3
"""Prepare or launch claude-deepseek aircraft image review agents."""
...
PROMPT_TEMPLATE = REPO_ROOT / "docs/aircraft-image-review-agent-prompt.md"
...
def main() -> int:
    ...
    parser.add_argument("--packet-glob", default="aircraft_image_review_*.json")
    ...
    if not packets:
        print("No review packets found. Run scripts/export_aircraft_image_review_packet.py first.")
        return 1
